...
public class directorShowController implements Initializable {
    static private final ObservableList<dataDB> dataD = showingController.data;
    ...
    @FXML
    private Text name, birth, prestige;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        name.setText(dataD.get(0).getName());
        birth.setText(dataD.get(0).getYearD().toString());
        prestige.setText(dataD.get(0).getPrestigeD());
    ...
    public void findFilmOfActor(){
        new searchModel().searchFilmDirector(dataF, dataD.get(0).getName());
    }
